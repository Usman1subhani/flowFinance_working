...
const TransactionItem: React.FC<TransactionItemProps> = ({ transaction, onEdit, onDelete }) => {
    ...
    return (
        <>
            <div className="flex flex-col gap-3 py-4 hover:bg-slate-50/50 transition-all group border-b border-slate-100 last:border-0 px-2 group">
                    ...
                    <div className="ml-14 pr-24">
                        ...
                        <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden">
                            <div
                                ...
                                style={{ width: `${Math.min(progress, 140)}%` }} // Allow slight overflow visual or cap at 100%
                            />
                        </div>
                    </div>
                )}
